...
namespace WebBookstore.Controllers
{
    public class BookstoresController : Controller
    {
        ...
        public BookstoresController(BookdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Bookstores != null ? 
                          ...
                          Problem("Entity set 'BookdbContext.Bookstores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookdbContext.Bookstores'  is null.");
            }
            var bookstore = await _context.Bookstores.FindAsync(id);
            if (bookstore != null)
            {
